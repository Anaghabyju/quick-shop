...
if(isset($_POST['b1'])){
    ...
    mysqli_query($con,"INSERT INTO customer_tbl(login_id,customer_name,email,phone,district,password,type,profile) VALUES('$log','$name','$email','$phone','$district','$password','$type','$filenew')");
  }
